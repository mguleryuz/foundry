...
contract ERC20Issuance_v1Test is Test {
    // CONSTANTS
    uint256 constant MAX_SUPPLY = type(uint256).max - 1;
    ...
    function setUp() public {
        ...
        token = new ERC20Issuance_v1(NAME, SYMBOL, DECIMALS, MAX_SUPPLY, deployer);
    }
    ...
    function testMint() public {
        ...
        assertEq(deployerBalance, mintAmount, "Deployer should have the minted amount");
    }
